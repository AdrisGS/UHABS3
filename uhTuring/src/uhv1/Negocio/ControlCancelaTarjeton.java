...
public class ControlCancelaTarjeton {
    ...
    private Tarjeton tarje [];
    private Responsable res;
    
    /*
    Constructor de control cancela tarjeton
    */
    public ControlCancelaTarjeton(Responsable res, DAOTarjeton daotar, Tarjeton tarje[]){
        this.res=res;
        this.daotar=daotar;
        this.tarje=tarje;
    }
    ...
    */
    public void iniciar(){
        VentanaCancelaTarjeton ventanaCancelaT = new VentanaCancelaTarjeton(this,tarje);
    ...
    */
    public void mandarControlGestionTarjeton(){
        ControlGestionTarjeton control = new ControlGestionTarjeton(res,daotar,tarje);
        control.inicia();
    }
    ...
    */
    public int advertirCancelarTarjeton(int numEstacionamiento, int idHabitante){
        int i=0;
        int valor = 0;
        
        
        Tarjeton tarjeton;
        tarjeton=daotar.buscarTarjetonNum(numEstacionamiento, idHabitante); //regrasa el tarjeton buscado con dicho
    ...
    */
    public Tarjeton aceptarCancelar(Tarjeton tarje){
        
        String estado;
        estado="Cancelado";
        
        tarje.setEstado(estado);
    ...
    */
    public void exitoCancelar(Tarjeton tarjeton){
        ...
        Tarjeton tarje=this.aceptarCancelar(tarjeton);//se regresa el tarjeton con su estado
                                                      //en cancelado 
        respuesta=daotar.actulizarEstado(tarje); //manda al tarjeton a actualiza en el dao 
